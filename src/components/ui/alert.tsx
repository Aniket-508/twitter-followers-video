  ...
  "grid gap-0.5 rounded-lg border px-4 py-3 text-left text-sm has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2.5 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4 w-full relative group/alert",
  {
    variants: {
      variant: {
        ...
        info: "bg-blue-500/10 border-blue-500/20 text-blue-700 dark:text-blue-400 *:data-[slot=alert-description]:text-blue-600/80 dark:*:data-[slot=alert-description]:text-blue-400/80",
        success:
          "bg-green-500/10 border-green-500/20 text-green-700 dark:text-green-400 *:data-[slot=alert-description]:text-green-600/80 dark:*:data-[slot=alert-description]:text-green-400/80",
      },
    },
    defaultVariants: {
      variant: "default",
